...
<head>
    ...
    <header class="home-header" style="margin-top: -10px;margin-bottom: -10px;"><img class="d-block float-left" src="assets/img/signup header.jpg" style="width: 100%;" /></header>
