        ...
        <div class="about-heading-content">
            <div class="row" style="margin-right: 0px;margin-left: 0px;">
                <div class="col-9 text-center mx-auto" style="background-color: #ffffff;color: rgb(0,0,0);opacity: 1;padding-bottom:20px; margin-top: 50px;margin-bottom: 50px;">
                    ...
                    <div class="dropdown"><button class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button" style="margin-right: 0px;">Accounts</button>
 ...
 <div class="col-md-12" style="padding-left: 80px;padding-right: 80px;padding-top:30px;">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                ...
                <button class="btn btn-light action-button" id="addBtn" style="color: white; background-color: black; border: none; float: left; margin-bottom: 10px;" data-toggle="modal" data-target="#addUser" onclick="showAddBtn();">Add Accounts</button>
              </div>
                ...
                <table class="table table-striped table-hover" id="prodTbl">
                    ...
                    <?php
                      ...
                      $conn = new mysqli($servername, $username, $password, $dbname);
                       $sql = "SELECT * FROM tbllogin where role like 'user'";
                    ...
                    ?>
                     ...
                     <tr style="text-align: center; color: black;">
                         <td data-label="ID"><?php echo $row['username']?></td>
                         <td data-label="Name"><?php echo $row['password']?></td>
                         <td data-label="Description"><?php echo $row['role']?></td>
